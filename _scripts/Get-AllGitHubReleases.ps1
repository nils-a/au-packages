...
# original taken from https://raw.githubusercontent.com/AdmiringWorm/chocolatey-packages/0f3b93ab7b067b265a06349a68297d07b1598e64/scripts/Get-AllGithubReleases.ps1
